...
<body>
    ...
    <form id="form1" runat="server">
        <div align="center">
            ...
            <br />
            <asp:TextBox class="form-control" ID="usertxt" runat="server" OnTextChanged="usertxt_TextChanged"></asp:TextBox>
    <br />
      ...
      <div class="row mt-4">
        ...
        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="fa-ul" style="margin-left: 1.65em;">
            <li class="mb-3">
              <span class="fa-li"><i class="fas fa-home"></i></span><span class="ms-2">Karachi, KHI 10012, Pakistan</span>
            </li>
            <li class="mb-3">
              <span class="fa-li"><i class="fas fa-envelope"></i></span><span class="ms-2"></span>
            </li>
            <li class="mb-3">
              <span class="fa-li"><i class="fas fa-phone"></i></span><span class="ms-2">+92 1111111111</span>
            </li>
            <li class="mb-3">
              <span class="fa-li"><i class="fas fa-print"></i></span><span class="ms-2">+92 1111111111</span>
            </li>
          </ul>
        </div>
        <!--Grid column-->
